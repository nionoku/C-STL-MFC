...
// Speed.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSpeedApp, CWinApp)
...
// Единственный объект CSpeedApp

CSpeedApp theApp;


// инициализация CSpeedApp

BOOL CSpeedApp::InitInstance()
{
