...
// обработчик нажатия на кнопку с выводом месседж бокса
...
// обрабочик нажатия на кнопку выхода
void CMFC_1Dlg::OnClickedExitButton()
{
	OnOK();
}

// обработчик нажатия на кнопку, выводит сообщение и системный сигнал
