...
// MFC_8.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFC_8App, CWinApp)
...
// Единственный объект CMFC_8App

CMFC_8App theApp;


// инициализация CMFC_8App

BOOL CMFC_8App::InitInstance()
{
