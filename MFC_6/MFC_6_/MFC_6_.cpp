...
// MFC_6_.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFC_6_App, CWinApp)
...
// Единственный объект CMFC_6_App

CMFC_6_App theApp;


// инициализация CMFC_6_App

BOOL CMFC_6_App::InitInstance()
{
