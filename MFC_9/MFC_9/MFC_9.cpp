...
// MFC_9.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFC_9App, CWinApp)
...
// Единственный объект CMFC_9App

CMFC_9App theApp;


// инициализация CMFC_9App

BOOL CMFC_9App::InitInstance()
{
