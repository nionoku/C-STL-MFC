...
// MFC_7.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFC_7App, CWinApp)
...
// Единственный объект CMFC_7App

CMFC_7App theApp;


// инициализация CMFC_7App

BOOL CMFC_7App::InitInstance()
{
