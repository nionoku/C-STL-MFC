...
// MFC_2_.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFC_2_App, CWinApp)
...
// Единственный объект CMFC_2_App

CMFC_2_App theApp;


// инициализация CMFC_2_App

BOOL CMFC_2_App::InitInstance()
{
