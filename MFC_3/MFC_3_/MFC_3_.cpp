...
// MFC_3_.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFC_3_App, CWinApp)
...
// Единственный объект CMFC_3_App

CMFC_3_App theApp;


// инициализация CMFC_3_App

BOOL CMFC_3_App::InitInstance()
{
